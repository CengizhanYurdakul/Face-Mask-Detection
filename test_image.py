...
for j in range(len(results)):
    ...
    aligned_img = cv2.warpAffine(img, M, (128, 128), borderMode=cv2.BORDER_REPLICATE).astype("uint8")
    ...
    if int(result) == 1:
        ...
        cv2.putText(img, "Face without Mask!", (x1, y1), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 1)
    else:
        cv2.rectangle(img, (x1, y1), (x2, y2), (0, 255, 0), 2)
        cv2.putText(img, "Face with Mask!", (x1, y1-10), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 1)
